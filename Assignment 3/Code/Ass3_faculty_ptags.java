...
public class Crawler{
            ...
            static String file = "C:/Users/Admin/Desktop//5thSEM/WEB_TECH/Faculty_PTags.xls";
            static HSSFWorkbook book = new HSSFWorkbook();
            static HSSFSheet sheet = book.createSheet("Faculty_PTags Worksheet");
            ...
            public static void printtags(String Url)throws IOException
    {
        Document doc=Jsoup.connect(Url).get();
        Elements urls=doc.select("p");
